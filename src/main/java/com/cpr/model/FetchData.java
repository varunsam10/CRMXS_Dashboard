...
public class FetchData {
	 ...
	 * connection; else { try { //Properties prop = new Properties();
	 * //InputStream inputStream =
	 * FetchData.class.getClassLoader().getResourceAsStream("/db.properties");
	 * //prop.load(inputStream); String driver = "com.mysql.jdbc.Driver";
	 * //prop.getProperty("driver"); String url =
	 * "jdbc:mysql://localhost:3306/crmxsdashboard"; //prop.getProperty("url");
	 * String user = "root"; //prop.getProperty("user"); String password =
	 * "root"; //prop.getProperty("password"); Class.forName(driver); connection
	...
	public ArrayList<Countries> getAllCountries() {
		...
		try {
			...
			/*
			 * while(rs.next()) { Countries country=new Countries();
